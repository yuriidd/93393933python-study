...
def popular_names(names):
    pop_names = {}
    for name in names:
        if name.capitalize() in pop_names:
            pop_names[name.capitalize()] += 1
        else:
            pop_names[name.capitalize()] = 1
    return pop_names
y = popular_names(girl_names)
x = popular_names(boy_names) 
# ? what next xDD
#

#=================
europe.update([123, 12345])
